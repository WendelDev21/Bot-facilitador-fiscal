    ...
    def preencher_formulario(self, caminho_arquivo, nome_planilha):
        try:
            ...
            for linha in sheet_teste.iter_rows(min_row=2):
                ...
                pyautogui.click(742,259,duration=1)
